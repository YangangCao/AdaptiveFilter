...
%   updating.                                                                   %
%                                                                               %
%     Adaptive Algorithm used here: SM_NLMS                                     %
%                                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for l=1:ensemble,
    ...
    S   =   struct('gamma_bar',gamma_bar,'filterOrderNo',(N-1),'initialCoefficients',...
                   W(:,1,l),'gamma',gamma);
    [y,e,W(:,:,l),nUp(1,l)]  =   SM_NLMS(d,transpose(x),S);
...
fprintf('\n');
fprintf('The average number of updates performed by SM_NLMS Algorithm was %3.2f (in a total of %i iterations) ;\n',nUp_av, K);
fprintf('Therefore, SM_NLMS Algorithm updated only %f percent of the time.\n',pUp_av);
fprintf('\n');
