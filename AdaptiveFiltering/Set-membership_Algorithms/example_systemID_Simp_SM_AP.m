...
%   updating.                                                                   %
%                                                                               %
%     Adaptive Algorithm used here: Simp_SM_AP                                  %
%                                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for l=1:ensemble,
    ...
    [y,e,W(:,:,l),nUp(1,l)]  =   Simp_SM_AP(d,transpose(x),S);
...
fprintf('\n');
fprintf('The average number of updates performed by the Simplified SM_AP Algorithm was %3.2f (in a total of %i iterations) ;\n',nUp_av, K);
fprintf('Therefore, Simplified SM_AP Algorithm updated only %f percent of the time.\n',pUp_av);
fprintf('\n');
