...
%   updating.                                                                   %
%                                                                               %
%     Adaptive Algorithm used here: NLRLS_pos                                    %
%                                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for l=1:ensemble,
    ...
    [ladder(:,:,l),kappa(:,:,l),e(:,:,l)]  =   NLRLS_pos(d,transpose(x),S);                   %%% Algorithm 7.2        
...
fprintf('  The relationship between the coefficients of the ladder-lattice and the coefficients of the \n transversal filter is not as direct as in the other lattice algorithms.\n\n');
