...
%   updating.                                                                   %
%                                                                               %
%     Adaptive Algorithm used here: QR_RLS                                      %
%                                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
W       = zeros(N,(K),ensemble);    % coefficient vector for each iteration and realization   %%%% PQ pude tirar o +1 daqui?????????????  Pq nao tem inicializacao!!!
...
for l=1:ensemble,
    ...
    x        = sign(randn(K,1));% Creating the input signal
                                                                % (normalized)
    ...
    S   =   struct('lambda',lambda,'filterOrderNo',(N-1));
    [e,W(:,:,l)]  =   QR_RLS(d,transpose(x),S);
