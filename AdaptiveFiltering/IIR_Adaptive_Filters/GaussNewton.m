function [outputVector, ...
          errorVector,...
          thetaVector] = GaussNewton(desired,input,S)
...
% 
%   Syntax:
%       [outputVector,errorVector,thetaVector] = GaussNewton(desired,input,S)
% 
%   Input Arguments: 
...
for it = 1:nIterations
   ...
   S_d       = inv(1 -S.alpha)*...
               ...
               (((1 -S.alpha)/S.alpha) + PhiVector.'*S_d*PhiVector));
            
   
    % Update Coefficients
    thetaVector(:,it+1) = thetaVector(:,it) -S.step*S_d*PhiVector*errorVector(it);                      
