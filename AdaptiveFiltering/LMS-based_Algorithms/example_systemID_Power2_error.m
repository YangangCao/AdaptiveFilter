...
%   updating.                                                                   %
%                                                                               %
%     Adaptive Algorithm used here: Power-of-Two Error                          %
%                                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
bd          = 15;                      % word-length in bits minus 1 (signal bit) 
                                       % (this is used for the quantization)
...
for l=1:ensemble,
    ...
    S =   struct('step',mu,'filterOrderNo',(N-1),'initialCoefficients',...
                   W(:,1,l),'bd',bd,'tau',tau); 
    [y,e,W(:,:,l)]  =   Power2_error(d,transpose(x),S);
