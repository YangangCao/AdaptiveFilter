...
%   updating.                                                                   %
%                                                                               %
%     Adaptive Algorithm used here: LMS-Newton                                  %
%                                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
initialInvRxHat = gamma*eye(N);     % initial estimate of the inverse of the autocorrelation matrix
...
for l=1:ensemble,
    ...
    S   =   struct('step',mu,'filterOrderNo',(N-1),'initialCoefficients',W(:,1,l),...
                   'alpha', alpha, 'initialInvRxHat',initialInvRxHat);
    [y,e,W(:,:,l)]  =   LMS_Newton(d,transpose(x),S);
