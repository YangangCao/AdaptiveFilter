...
%   updating.                                                                   %
%                                                                               %
%     Adaptive Algorithm used here: Alternative RLS                             %
%                                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
W       = zeros(N,(K+1),ensemble);  % coefficient vector for each iteration and realization; w(0) = [1 1 1 1].'
...
for l=1:ensemble,
    ...
    S   =   struct('filterOrderNo',(N-1),'initialCoefficients',W(:,1,l),...
                   'delta',delta,'lambda',lambda);
    [y,e,W(:,:,l),yPost,ePost]  =   RLS_Alt(d,transpose(x),S);
